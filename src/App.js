...
// <tr>
//   <th><Nametag name="Defaults" short="Dfl" useShorts={this.state.settings.ui.preferences.useShorts}/></th>
// </tr>
// <tr>
//   <td><Nametag name="Defaultcolor" short="Dcl" useShorts={this.state.settings.ui.preferences.useShorts}/></td>
//   <td><Color target="ui.defaults.color" value={this.state.defaults.color} callback={this.update.bind(this,"ui.defaults.color")}/></td>
// </tr>
...
//   callback={this.update.bind(this)} useShorts={this.state.ui.settings.preferences.useShorts} showTooltips={this.state.settings.ui.preferences.showTooltips}
...
class App extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      states: { //states for various toggleable ui elements
      },
  ...
  render() {
    let layer = this.state.layers.selected != -1 ? true : null
    return (
      <main>
        <PanelTable name="Settings" short="SET" useShorts={this.shorts()}>
          <PanelSection name="UI/UX" short="UIX" useShorts={this.shorts()}>
            <PanelToggle name="Shortcuts" short="Cut"
              ...
              callback={this.update.bind(this)} useShorts={this.shorts()} showTooltips={this.tips()}
          ...
          <PanelSection name="Clock" short="CLK" useShorts={this.shorts()}>
            ...
            <PanelSlider name="BPM" short="Bpm"
              ...
              relative={true} min={10} max={600} relative={false}
